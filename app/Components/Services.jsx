    ...
    const servicesData = [
        {
            ...
            description: "I create responsive and dynamic web applications using modern technologies like React, Next.js, and Node.js. Focusing on clean code, performance, and user experience.",
            features: [
                { icon: FaLaptopCode, text: "Custom Web Applications" },
                { icon: FaDesktop, text: "Responsive Design" },
                { icon: FaCode, text: "Clean & Optimized Code" },
            ],
            mainIcon: FaCode,
        },
        {
            title: "UI/UX Design",
            description: "I design intuitive and engaging user interfaces with a focus on user experience. Creating visually appealing designs that enhance user interaction and satisfaction.",
            features: [
                { icon: FaFigma, text: "Figma Design" },
                { icon: FaPalette, text: "UI Components" },
                { icon: FaSwatchbook, text: "Design Systems" },
            ],
            mainIcon: FaPaintBrush,
        }
    ];
                    ...
                    >
                        ...
                        <div className='relative z-10'>
                            <div className='bg-blue-100 dark:bg-blue-900/30 w-16 h-16 rounded-2xl flex items-center justify-center mb-6
                                ...
                                <service.mainIcon className="w-8 h-8 text-blue-600 dark:text-blue-400" />
                            </div>
