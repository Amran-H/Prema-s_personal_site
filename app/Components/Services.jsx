                ...
                className='grid sm:grid-cols-2 lg:grid-cols-4 gap-6 my-10'>
                {
                    serviceData.map(({ icon, title, description, link }, index) => (
                        <motion.div
                            ...
                            key={index}
                            className='border border-gray-400 rounded-lg px-8 py-12 cursor-pointer hover:bg-lightHover
                        hover:-translate-y-4 duration-500 hover:shadow-black
                         text-center dark:hover:bg-darkHover dark:hover:shadow-white'
                        >
