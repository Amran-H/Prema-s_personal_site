...
const Header = () => {
    ...
    return (
        <>
            ...
            <div className={`w-11/12 max-w-5xl text-center mx-auto min-h-screen pt-10 sm:py-0 flex flex-col items-center justify-center gap-4 ${!imageLoaded ? 'hidden' : ''}`}>
                {/* Platform Buttons - Sticky on left side */}
                <motion.div
                    initial={{ scale: 0 }}
                    whileInView={{ scale: 1 }}
